...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { game_id: @award.game_id, image: @award.image, min_rank: @award.min_rank, name: @award.name, weekly: @award.weekly } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { game_id: @award.game_id, image: @award.image, min_rank: @award.min_rank, name: @award.name, weekly: @award.weekly } }
